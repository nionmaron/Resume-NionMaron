...
::: img-container
<img src="images/profile.png" alt="Descriptive Alt Text"/>
:::
...
<p class="small">
This resume was last updated on `r format.Date(Sys.Date(), "%b %d, %Y")`. The code is available on [www.github.com/nionmaron/resume](https://github.com/nionmaron/resume)
</p>
:::
